...
def main():
    ...
    pygame.init()
    screen = pygame.display.set_mode((1336,800))
    ...
    # space.add_post_step_callback(space.remove, ball.body)
        ...
        line_point1 =  Vec2d((int(lonex)),(10*int(coordinates[lone][0])))

        line_point2 = Vec2d(((int(lonex))),(10*int(coordinates[lone+1][0])))

        body = pymunk.Body(body_type=pymunk.Body.STATIC)
        shape= pymunk.Segment(body, line_point2, line_point1, 10.0)
        shape.friction = 0
